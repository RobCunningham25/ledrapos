...
BEGIN
  ...
  LOOP
    ...
    IF v_existing_item_id IS NOT NULL THEN
      UPDATE tab_items
      SET qty = qty + v_qty,
          line_total_cents = (qty + v_qty) * unit_price_cents
      WHERE id = v_existing_item_id;
    ELSE
      INSERT INTO tab_items (venue_id, tab_id, product_id, qty, unit_price_cents, line_total_cents)
      VALUES (p_venue_id, v_tab_id, v_product_id, v_qty, v_unit_price_cents, v_qty * v_unit_price_cents);
    END IF;
  ...
  -- Return tab id and updated items
