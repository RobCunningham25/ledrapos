...
export function buildSystemPrompt(ctx: AssistantContext): string {
  ...
  return [
    ...
    "- If the member asks something about another member by name (e.g. 'is John on the committee'), politely deflect — you don't share information about other members.",
