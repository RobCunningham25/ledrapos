// Deno-compatible port of src/utils/eventOccurrences.ts. Pure TS — no browser-
// specific APIs — so the source is reproduced verbatim. Keep these in sync if
// either copy changes (rare; the algorithm is stable).
